...
# WinCatalyst Darwin-host: set the libdispatch cross compiler + runtime dir when a macOS
# host cross-builds a non-Darwin libdispatch (the NOT-Darwin block below is skipped there,
# so -DCMAKE_C_COMPILER= would be empty). Use the fork clang from the native tools path.
if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND NOT "${SWIFT_NATIVE_CLANG_TOOLS_PATH}" STREQUAL "")
  set(SWIFT_LIBDISPATCH_C_COMPILER "${SWIFT_NATIVE_CLANG_TOOLS_PATH}/clang")
  set(SWIFT_LIBDISPATCH_CXX_COMPILER "${SWIFT_NATIVE_CLANG_TOOLS_PATH}/clang++")
  ...
  foreach(arch ${ARCHS})
    ...
    if(sdk MATCHES WINDOWS)
      ...
      elseif(sdk STREQUAL "LINUX")
        set(SWIFT_LIBDISPATCH_COMPILER_TRIPLE_CMAKE_ARGS -DCMAKE_C_COMPILER_TARGET=${arch}-unknown-linux-gnu;-DCMAKE_CXX_COMPILER_TARGET=${arch}-unknown-linux-gnu;-DCMAKE_SYSROOT=${SWIFT_SDK_LINUX_ARCH_${arch}_PATH})
        set(SWIFT_LIBDISPATCH_LINKER_FLAGS "-fuse-ld=lld")
    endif()
    ...
    if(NOT SWIFT_SDK_${sdk}_STATIC_ONLY)
      ExternalProject_Add("${LIBDISPATCH_VARIANT_NAME}"
        ...
        "-DCMAKE_EXE_LINKER_FLAGS=${CMAKE_EXE_LINKER_FLAGS} ${SWIFT_LIBDISPATCH_LINKER_FLAGS}"
        "-DCMAKE_SHARED_LINKER_FLAGS=${CMAKE_SHARED_LINKER_FLAGS} ${SWIFT_LIBDISPATCH_LINKER_FLAGS}"
